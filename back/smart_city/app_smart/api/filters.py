...
class TemperaturaDataFilter(django_filters.FilterSet):
    timestamp_gte = django_filters.DateFilter(field_name='timestamp', lookup_expr='gte')
    timestamp_lte = django_filters.DateFilter(field_name='timestamp', lookup_expr='lte')
    sensor = django_filters.NumberFilter(field_name='sensor')
    valor_gte = django_filters.NumberFilter(filter_name='valor', lookup_expr='gte')
    valor_lte = django_filters.NumberFilter(filtername='valor', lookup_expr='lte')
    class Meta:
